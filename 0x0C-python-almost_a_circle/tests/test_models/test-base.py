...
"""Defines unittests for base.py.
 ...
 Unittest classes:
	...
	TestBase_from_json_strings - line 232
	TestBase_create - line 286
	TestBase_load_from_json_string - line 338
...
self.assertTrue(len(Base.to_json_string([s.to_dictionary()])) == 39)
	...
	self.assertTrue(len(Base.to_json_string(last_dicts)) == 78)
...
class TestBase_save_to_file(unittest.TestCase):
    ...
    def test_save_to_file_one_aquare(self):
	s = Square(10, 7, 2, 8)
	Square.save_to_file([s])
	with open("Square.json", "r") as f:
	    self.assertTrue(len(f.read()) == 39)

    def test_save_to_file_cls_name_for_filename(salf):
	s = Square(10, 7, 2, 8)
	Base.save_to_file([s])
